 ...
 * 
 */
package com.star.sud.onetomany.foreignKeyAsso;
...
public class MainClassForeignKeyApp {
	...
	public static void main(String[] args) {
		...
		Set<TOrder> firstOrders = new HashSet<TOrder>();
		firstOrders.add(tOrder1);
		firstOrders.add(tOrder2);

		Set<TOrder> secondOrders = new HashSet<TOrder>();
		secondOrders.add(tOrder3);
		...
		firstCustomer.setOrders(firstOrders);
		...
		secondCustomer.setOrders(secondOrders);
